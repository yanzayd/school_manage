<%-- 
    Document   : tiuser
    Created on : Aug 27, 2019, 9:13:33 AM
    Author     : root
--%>
		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Titulaire</a>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled placeholder="School " value="School Management.">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                     <a href="#">
                                    <img class="avatar border-gray" src="../style/img/faces/face-3.jpg" alt="..."/>

                                      <h4 class="title">Titulaire<br />
                                         <small>...</small>
                                      </h4>
                                    </a>
                                </div>
